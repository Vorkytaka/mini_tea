...
/// A testing extension for classes implementing [IUpdate].
///
/// This extension simplifies testing [IUpdate] implementations by
/// validating the resulting state and effects in response to a given state and message.
///
/// ### Usage:
/// Use this extension in your test cases to validate the correctness of your
/// [IUpdate] implementations, similar to testing [Update] functions.
///
/// Example:
/// ```dart
/// final update = MyUpdateImplementation();
/// update.test(
///   state: MyState.initial(),
///   message: MyMessage.update(),
///   expectedState: MyState.updated(),
